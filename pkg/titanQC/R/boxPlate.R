#' Generate a boxplot of expression intensities for each well on the plate 
...
#' @return for each of the plates contained in the ExpressionSet object 'eset' a plot is generated 
#' @export
